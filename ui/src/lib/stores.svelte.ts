...
export const profile = reactiveWritable<UserProfile>(structuredClone(defaultProfile));
export const portfolio = reactiveWritable<Portfolio>(structuredClone(defaultPortfolio));
