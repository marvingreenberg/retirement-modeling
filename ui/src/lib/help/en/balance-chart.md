...
When the total portfolio value trends upward or stays flat, the plan is sustainable. A downward slope indicates drawdown — normal in retirement, but reaching zero before the end of the timeline signals the portfolio is depleted. The relative size of each colored band shows the asset allocation shift over time as withdrawals, conversions, and growth reshape the portfolio.
