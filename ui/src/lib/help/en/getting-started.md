...
This retirement simulator models how a portfolio evolves over time under different spending, investment, and tax assumptions. Your account data is not _stored_ in a server - only certain account, income and budgeting information is
...
1. Set your current age and planned retirement age in the profile drawer (top-left).
2. Add investment accounts with current balances — at minimum, one account is needed.
