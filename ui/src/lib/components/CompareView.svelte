<script lang="ts">
   ...
   let bestBalance = $derived(
      snapshots.length > 0
         ? Math.max(...snapshots.map((s) => s.finalBalance))
         : 0,
   );
   let bestTax = $derived(
      snapshots.length > 0
                  ...
                  <tr>
                     ...
                     <td
                        ...
                        class:text-success-600={snap.finalBalance ===
                           bestBalance}>{currency(snap.finalBalance)}</td
                     >
                     <td
                        class:font-bold={snap.totalTaxes > 0 &&
                           snap.totalTaxes === bestTax}
                     ...
                     <td
                        class:font-bold={snap.successRate != null &&
                           snap.successRate === bestSuccess}
                        class:text-success-600={snap.successRate != null &&
                           snap.successRate === bestSuccess}
                     ...
                     <td>
                        <button
                           ...
                           onclick={() => removeSnapshot(snap.id)}>✕</button
                        >
                     </td>
                  </tr>
               {/each}
