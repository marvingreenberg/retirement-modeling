...
The UI project SHALL include Playwright as a devDependency with a configuration file targeting the local or containerized dev server.
...
A Playwright test SHALL verify the core simulate workflow end-to-end through the real API.
...
E2E tests SHALL use resilient locator strategies that survive layout changes.
