...
The spending page SHALL read from and write to the shared `portfolio` store. Changes made on the spending page are immediately reflected when running a simulation from the home page.
