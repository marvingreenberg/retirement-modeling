# ss-benefit-formula Specification

## Purpose
Social Security benefit calculation — actuarial reduction for early claiming, delayed retirement credits for late claiming, and auto-generation of SS income streams from profile configuration.
