# Tax Regime Data Specification

## Purpose
Define historical tax regime data and sampling logic for Monte Carlo tax policy variation.
...
- **THEN** it SHALL include:
  - `name`: descriptive label (e.g., "TCJA 2024")
...
- **THEN** approximately 7-8 regimes SHALL be available covering 1970s through TCJA
