## Purpose
Defines the contextual help drawer that provides in-app documentation organized by topic, with route-based default topics, maximize toggle, and internal navigation.
## Requirements
