## Purpose
Defines inline section warnings and simulate-blocking behavior when portfolio prerequisites are missing.
...
### Requirement: No inline warnings in results area
Warnings for missing prerequisites SHALL be shown inline within PortfolioEditor sections, not as banners in the results area.

#### Scenario: No inline warnings on Overview
